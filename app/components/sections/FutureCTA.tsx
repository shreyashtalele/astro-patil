...
export default function FutureCTA() {
  ...
  useEffect(() => {
    ...
    const buildParticles = () => {
      ...
      const count = w < 480 ? 20 : w < 768 ? 30 : 45;
      ...
      <div className="section-container relative z-10">
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            <h2
              className="
              mb-4 font-semibold leading-tight tracking-tight text-white
              text-[26px]
              sm:text-[36px]
              md:text-[44px]
              lg:text-[52px]
          ...
          <motion.p
            ...
            className="mx-auto mb-8 max-w-md text-sm leading-relaxed text-[#F2D6A0]/50 sm:mb-10 sm:text-[15px]"
          >
            Get personalised guidance rooted in ancient Vedic wisdom. Your
